        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int index,
                ...
                if (currentLevel == LEVEL_PROVINCE) {
                    ...
                    intent.putExtra("city_py_name", coolWeatherDB.countyCodeToCityPyName(countyCode));
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    ...
                    result = Utility.handleCitiesResponse(coolWeatherDB,response, selectedProvince.getId(),selectedProvince.getProvincePyName());
                } else if ("county".equals(type)) {
                    result = Utility.handleCountiesResponse(coolWeatherDB,response, selectedCity.getId(),selectedCity.getCityPyName());
                }
                if (result) {
